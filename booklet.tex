...
\thispagestyle{empty}
\begin{landscape}
\newgeometry{textwidth= 21 cm, left = 4cm, top = 7.2cm}
	%\begin{center}
\hspace{105mm}	\hypertarget{talks}{\textsc{\Huge TITLE}}\\ %% -- Add your TITLE here and modify the hspace

\hspace{105mm}  \textsc{\LARGE Schedule}
\\

\hspace{113mm}  \textsc{\LARGE DATE} %% --- Add here and mod hspace
\\

\hspace{113mm} {\LARGE YEAR} %% Add or remove
	%\end{center}
